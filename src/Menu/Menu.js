        ...
        <div className="menu">
          ...
          <ul className="nav-links">
            ...
            <li>
              ...
              <ul className="drop-menu">
                <li><FontAwesomeIcon className='right-arrow-icon' icon={faAngleRight}></FontAwesomeIcon><a href="/">Office Environment</a></li>
                ...
                <li><FontAwesomeIcon className='right-arrow-icon' icon={faAngleRight}></FontAwesomeIcon><a href="/">Fearwell Programme</a></li>
